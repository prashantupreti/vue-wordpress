      ...
      <nav class="px-6 py-4 bg-white shadow">
          <div class="container flex flex-col mx-auto md:flex-row md:items-center md:justify-between">
              ...
              <div class="flex-col hidden md:flex md:flex-row md:-mx-4">
                ...
                <router-link to="/about" class="my-1 text-gray-800 hover:text-blue-500 md:mx-4 md:my-0">About</router-link> |
                <router-link to="/blog" class="my-1 text-gray-800 hover:text-blue-500 md:mx-4 md:my-0">Blog</router-link>
              </div>
          </div>
      </nav>
